            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            ...
                            types: data.types.map(function (t) { return ({ type: t.type.name }); }),
                        }];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(id <= 20)) return [3 /*break*/, 5];
                    return [4 /*yield*/, fetchPokemon(id)];
                case 2:
                    pokemon = _a.sent();
                ...
                case 3:
                    _a.sent();
                    console.log("\u2705 Inserted ".concat(pokemon.name));
                    _a.label = 4;
                case 4:
                    id++;
                    return [3 /*break*/, 1];
